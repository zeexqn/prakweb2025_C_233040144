...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['title' => 'zezee App', 'description' => '', 'showNavbar' => true]));
...
foreach (array_filter((['title' => 'zezee App', 'description' => '', 'showNavbar' => true]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
</html><?php /**PATH D:\KULIAH\prakweb2025_C_233040144\Pertemuan 4\latihan\resources\views/components/layout.blade.php ENDPATH**/ ?>