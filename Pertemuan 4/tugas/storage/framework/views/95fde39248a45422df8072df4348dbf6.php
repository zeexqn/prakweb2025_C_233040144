...
<body class="bg-gray-50 text-gray-800">
 <nav class="bg-indigo-700 shadow-md sticky top-0 z-10">
    ...
    <h1 class="text-4xl text-center"><?php echo e($description); ?></h1>
    <?php echo e($slot); ?>

<footer class="bg-gray-900 mt-auto">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 text-center">
            <h3 class="text-gray-400 text-sm font-light">
                &copy; <?php echo e(date('Y')); ?> Copyright By <span class="text-indigo-400 font-medium">Azharmtq</span>. All rights reserved.
            </h3>
...
</html><?php /**PATH C:\Users\MyPC PRO\Downloads\prakweb2025_C_233040144-main\pertemuan3\tugas\resources\views/components/layout.blade.php ENDPATH**/ ?>